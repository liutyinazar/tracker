...
urlpatterns = [
    ...
    # path("api/v1/teams/<int:pk>/chanel/", TeamList.as_view()),
    ...
    path("api/v1/teams/<int:pk>/chanel/", TeamChanelListView.as_view()),  # chanel
    path(
        "api/v1/teams/<int:team_pk>/chanel/<int:chanel_pk>/",
        TeamChanelTaskListView.as_view(),
        name="team-chanel-list",
    ),
